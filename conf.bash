...
echo -en "${CYAN}HOSTNAME:${RESET}"
read host_name
echo -en "${CYAN}USERGROUP:${RESET}"
read user_group
echo -en "${CYAN}USERGROUP_ID:${RESET}"
read user_grpid
echo -en "${CYAN}MAILBASE:${RESET}"
read mail_base_rnd
mail_base="${mail_base_rnd%/}"
echo -en "${CYAN}SSL_CERT:${RESET}"
read ssl_cert
echo -en "${CYAN}SSL_KEY:${RESET}"
read ssl_key
